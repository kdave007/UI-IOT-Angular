...
export class NbPasswordAuthStrategyOptions extends NbAuthStrategyOptions {
  ...
  //baseEndpoint? ="http://hTelemetry.atechnik.com.mx/";
  baseEndpoint? ="http://coolchain.com.mx:94/";
  //baseEndpoint? ="http://localhost:94/"; // CHANGE THIS COMMENT
  //baseEndpoint? ="http://coolchain.atechnik.com.mx/";
  //baseEndpoint? ="http://192.168.50.246:8080/";
  login?: boolean | NbPasswordStrategyModule = {
    alwaysFail: false,
    endpoint: 'login',// << ------------ here we handle the login post 
    //endpoint: 'mother_base.php',
    method: 'post',
    ...
    defaultErrors: ['Login/Email es incorrecto, intenta de nuevo.'],
    defaultMessages: ['¡Es un placer tenerlo de vuelta!. Iniciando...'],
  };
