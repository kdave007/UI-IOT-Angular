...
@Component({
  selector: 'gpios-chartjs-line',
  templateUrl: './gpios-chart.component.html',
  styleUrls: ['./gpios-chart.component.scss']
})
export class GpiosChartComponent implements OnInit {
  ...
  private createChart(){
      ...
      for(let c=0;c<11;c++){
        dataset[c]= this.setGpiosView('Puerta trasera',se[c],colours[c],border_colours[c]);
      ...
      this.options = {
        ...
        document.getElementById('tooltipGPIOS').textContent = label;
        return;
